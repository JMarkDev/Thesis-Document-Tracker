...
const VerifyCampusAdminOTP = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post("/auth/campus-admin-verify", data, {
...
VerifyCampusAdminOTP.propTypes = {
...
export default VerifyCampusAdminOTP;
