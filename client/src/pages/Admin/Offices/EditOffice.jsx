...
const EditOffice = ({ modal, closeModal, id }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await api.put(`/office/update/id/${id}`, formData);
              ...
              >
                ...
                <div className="flex flex-col">
                  <div className="relative mt-4">
                    <input
                      ...
                      id="officeName"
                      className={`${
                        officeNameError ? "border-red-500 " : "border-gray-300 "
                ...
                <div className="flex flex-col">
                  <div className="relative mt-4">
                    ...
                    >
                      Email Address |{" "}
                      <span className="font-bold cursor-pointer text-[#1a9cb7]">
                        Change
                      </span>
                    </label>
                  </div>
