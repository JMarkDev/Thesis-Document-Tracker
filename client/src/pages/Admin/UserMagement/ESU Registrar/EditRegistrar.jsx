...
const EditRegistrar = ({ modal, closeModal, id }) => {
  ...
  const registrar = useSelector(getFetchedUserById);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("email", registrar.email);
  ...
  useEffect(() => {
    if (registrar) {
      ...
      setValue("esuCampus", registrar.esuCampus);
      setValue("firstName", registrar.firstName);
      setValue("lastName", registrar.lastName);
      setValue("middleInitial", registrar.middleInitial);
      setValue("email", registrar.email);
      setValue("birthDate", registrar.birthDate);
      setValue("contactNumber", registrar.contactNumber);
      setValue("designation", registrar.designation);
    }
  }, [registrar, setValue]);
              ...
              <div className="p-4  space-y-4 text-sm text-[#221f1f]">
                ...
                >
                  <div className="flex justify-center items-center">
                    <Profile setValue={setValue} image={registrar?.image} />
                  </div>
                  ...
                  <div className="flex flex-col">
                    <div className="relative mt-4">
                      ...
                      >
                        ...
                        <option value="Registrar Aide">Registrar Aide</option>
