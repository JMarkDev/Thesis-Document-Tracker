...
const AddStaff = ({ modal, closeModal, officeId }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await api.post("/office/add-staff", formData);
          ...
          <div className="relative w-full max-w-2xl max-h-full py-5 ">
            <div className="relative text-gray-800 bg-white rounded-xl shadow-lg">
              <div className="flex items-center justify-center">
                <h1 className="md:text-2xl font-bold text-lg p-4">Add Staff</h1>
                <button
                  type="button"
